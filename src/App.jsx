...
//   Smartphone, Layout, Globe, PenTool, Terminal, Award, ExternalLink
// } from 'lucide-react';
...
//   <div className="flex items-center gap-4 mb-5 group text-left">
//     <div className="w-10 h-10 bg-[#1e293b] rounded-xl flex items-center justify-center text-[#ffdb70] shadow-md border border-slate-700 group-hover:border-[#ffdb70]/50 transition-colors shrink-0">
//       <Icon size={18} />
//     </div>
...
//   tech={["React.js", "Tailwind CSS", "PostgreSQL", "SDLC", "Framer Motion", "Node.js"]}
//   description="A recruitment platform designed to help hiring teams find and manage candidates more efficiently through a smooth workflow and modern user interface."
//   link="https://swifthire-io.vercel.app/"   // or GitHub / demo link
// /> */}
// <a
//   href="https://swifthire-io.vercel.app/"
//   target="_blank"
...
// <a
//   href="https://healthivo.vercel.app/"
//   target="_blank"
//   rel="noopener noreferrer"
//   style={{ display: "block" }}
// >
...
//             <div className="w-36 h-36 bg-[#2d3a4f] rounded-2xl overflow-hidden flex items-center justify-center border border-slate-700 shadow-inner">
//               <img src={profilePic} alt="Pawan" className="w-full h-full object-cover object-top" />
//             </div>
//             <h1 className="text-2xl font-bold text-white text-center whitespace-nowrap">Pawan Prasad Sahu</h1>
//             <span className="text-[12px] bg-[#2d3a4f] text-slate-100 px-4 py-1.5 rounded-lg mt-4 font-medium">Software Engineer</span>
//           </div>
...
//             <InfoItem icon={Terminal} label="LeetCode" isLink value={<a href="https://leetcode.com/u/sahux07/" target="_blank" className="text-blue-400 hover:underline">50+ Problem Solved</a>} />
//             <InfoItem icon={Award} label="Achievement" value="Coming Soon" />
//             <InfoItem icon={Briefcase} label="Internship" isLink value={<a href="https://digitalnexusai.com/" target="_blank" className="text-blue-400 hover:underline">Digital Nexus AI</a>} />
//           </div>

//           <div className="flex justify-center gap-5 mt-8 text-slate-400">
//             <a href="https://github.com/Pawansahu247" className="text-slate-400 hover:text-[#ffdb70]"><Github size={18} /></a>
//             <a href="https://www.linkedin.com/in/pawan247/" className="text-slate-400 hover:text-[#ffdb70]"><Linkedin size={18} /></a>
//             <Twitter size={18} className="hover:text-[#ffdb70] cursor-pointer" />
//             <a href="https://www.instagram.com/_sahu_245/" className="text-slate-400 hover:text-[#ffdb70]"><Instagram size={18} /></a>
//           </div>
//         </aside>
...
//                   <p className="uppercase tracking-widest text-sm">{activeTab} Section coming soon</p>
//                 </motion.div>
//               )}
//             </AnimatePresence>
//           </div>
